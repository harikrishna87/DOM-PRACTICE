      ...
      setTimeout(() => {
        name.innerHTML += `
            <div style="display: flex; flex-direction: column; align-items: center; 
                            ...
                            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); width: 300px; margin-bottom: 20px;
                            background-color: ${generateRandomColor()}">
                            <img src="${data[i].image}" 
                            width="200px" height="200px" style="border-radius: 8px;"/>
                            <h3>${data[i].title}</h3>
...
function Popover() {
  let popover = document.getElementById('my-popover1');
  popover.classList.add('active');
  setTimeout(function () {
    popover.classList.remove('active');
  }, 6000)
